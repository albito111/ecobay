...
error_reporting(0);
  ...
  if(isset($_GET['searchdata'])) { $searchdata=$_GET['searchdata'];  }
  if(isset($_POST['submit'])) { $searchdata=$_POST['searchdata'];  }
...
<title>EcoBay Freight Portal | Car Listing</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Search Result of keyword "<?php echo $searchdata;?>"</h1>
      </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">$<?php echo htmlentities($result->Price);?> Per Day</p>
                </div>
              </li>
              <?php }} ?>
