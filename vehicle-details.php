...
$status=0;
$vhid=$_GET['vhid'];
$bookingno=mt_rand(1000,  99999);
 
 $query = mysqli_query($con, "INSERT INTO `tblbooking`(`BookingNumber`,`userEmail`,`VehicleId`, `BookingDate`,`Quantity`,`Price`, `Status`) 
values('$bookingno','$useremail','$vhid','$BookingDate','$quantity','$price','$status')");
...
<title>EcoBay Freight | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>$<?php echo htmlentities($price= $result->Price);?> </p> excluding VAT
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="number" class="form-control" value="1" name="quantity"  id="quantity"min="1" max="100" onchange="multiply()"onkeyup="multiply()" required>
            </div>
            <div class="form-group">
              <label>Estimated Price:</label>
              <input type="number" class="form-control" name="price" id="price" value="<?php echo $price; ?>" required readonly >
              <input type="hidden" id="price1" value="<?php echo $price; ?>">
            </div>
            <div class="form-group">
              <p>Our sales team will contact you in less than 24hrs, after you have odered your vehicle online. </p>
            </div>
          <?php $kk=$_SESSION['Verified']; if($_SESSION['login']) {?>
		  ...
		  <?php } else{?>
		  <div class="form-group">
             <a href="complete_registration.php" class="btn btn-block">Complete Registration First  </a>
		  ...
		  <?php } ?>
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login To Order </a>
