...
$select = $pdo->prepare("SELECT * FROM tblbooking where status ='0'");
$select->execute();
...
$pdf->Cell(20,10 ,'Confirmed Bookings',0,1,'L');
//////////////////////////////////////////////
...
$select = $pdo->prepare("SELECT * FROM tblbooking where status ='1' ");
$select->execute();
while($item = $select->fetch(PDO::FETCH_OBJ)){
    ...
    $pdf->SetFont('Arial','B',5);
    $pdf->Cell(33,6,'Confirmed Booking',1,0,'C');    
